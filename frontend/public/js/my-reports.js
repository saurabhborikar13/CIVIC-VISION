      ...
      datasets: [
        {
          ...
          backgroundColor: 'rgba(60, 83, 120, 0.7)',
          borderColor: 'rgba(60, 83, 120, 1)',
          borderWidth: 1
        },
        {
          label: 'Resolved',
          data: data.resolvedData,
          backgroundColor: 'rgba(47, 122, 109, 0.7)',
          borderColor: 'rgba(47, 122, 109, 1)',
          borderWidth: 1
        }
      ]
    },
...
function addMetricStyles() {
  ...
  styleEl.textContent = `
    .stats-card {
      ...
      border: 1px solid #3c5378; /* Lighter border for a cleaner look */
    ...
    .stats-card:nth-child(1) .icon-circle { background-color: #3c5378; } /* Light blue */
    .stats-card:nth-child(2) .icon-circle { background-color: #2f7a6d; } /* Light green */
    .stats-card:nth-child(3) .icon-circle { background-color: #3c5378; } /* Light blue for resolution rate */
    .stats-card:nth-child(4) .icon-circle { background-color: #d79a2c; } /* Light yellow */
    .stats-card:nth-child(5) .icon-circle { background-color: #b0472f; } /* Light red */
    ...
    .dropdown-item.active {
      background-color: rgba(60, 83, 120, 0.1);
      color: #3c5378;
      font-weight: 500;
    }
    ...
    .stats-card p.text-muted {
        ...
        color: #4b5768; /* Standard muted text color */
  ...
  const printContent = `
    ...
    <head>
      ...
      <style>
        ...
        .print-date { font-size: 12px; color: #4b5768; }
        .section-title { 
          font-size: 16px; 
          font-weight: bold; 
